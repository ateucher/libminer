...
[![R-CMD-check](https://github.com/ateucher/libminer-dfo-2024-11/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/ateucher/libminer/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
devtools::install_GitHub("ateucher/libminer-dfo-2024-11")
```
